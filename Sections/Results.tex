...
\end{align*}
 ...
 The values for $k$ and $B$ of aluminium are obtained are: $k = \kaluminum \pm \dkaluminum$ and $B = \Baluminum \pm \dBaluminum$. The values for $k$ and $B$ of plastic are: $k = \kplastic \pm \dkplastic$ and $B = \Bplastic \pm \dBplastic$.  These error bars for aluminum and plastic are significantly too small, which also agrees with analysis of the chi-squared value.
...
\includegraphics[width=\MyWidth]{Figures/linearAluminumGraph.eps}
  \caption{Graph of $\ln(R(E))$ vs $\ln(E)$}
