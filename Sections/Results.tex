...
\end{align*}
 ...
 The values for $k$ and $B$ of aluminium are obtained are: $k = 0.449 \pm 0.009$ and $B = 0.998 \pm 0.033$.  The error bars for aluminum are tooThe values for $k$ and $B$ of plastic are: $k = 0.370 \pm 0.014$ and $B = 1.001 \pm 0.065$.  These error bars for aluminum are significantly too small, which also agrees with analysis of the chi-squared value. On the other hand, the error bars for plastic are probably too large as $\chi^2 \ll \text{N}-2$.
