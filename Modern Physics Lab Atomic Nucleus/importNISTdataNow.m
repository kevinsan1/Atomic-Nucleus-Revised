function [Kinetic,CSDA] = importNISTdataNow(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column
%vectors.
%   [KINETIC,CSDA] = IMPORTFILE(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   [KINETIC,CSDA] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
...
% Auto-generated by MATLAB on 2014/04/13 17:12:24
